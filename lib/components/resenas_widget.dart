                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text:
                              'Califica de 1 a 5 el servicio brindado por el proveedor',
                          style:
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text:
                              'Ahora, dinos a detalle tu opinión sobre el servicio brindado',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.inter(
                                      fontWeight: FontWeight.w500,
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Describe tu opinión aquí...',
                        hintStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  font: GoogleFonts.inter(
                                    fontWeight: FlutterFlowTheme.of(context)
                  ...
                  builder: (context) => Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        _model.comentarioResponse =
                            await ResenasTable().insert({
                          'solicitud_servicio_id':
                              _model.solicitud?.firstOrNull?.id,
                          'usuario_id': currentUserUid,
                          'proveedor_id':
                              _model.solicitud?.firstOrNull?.profesionalId,
                          'calificacion': _model.ratingBarValue?.round(),
                          ...
                          builder: (dialogContext) {
                            return Dialog(
                              ...
                              child: NotificacionesModalWidget(
                                titulo: 'Califica al proveedor',
                                descripcion:
                                    'Puntaje guardado, gracias por tus comentarios.',
                                estadosucess: true,
                                textobutton: 'Aceptar',
                                action1: () async {
                                  Navigator.pop(context);
