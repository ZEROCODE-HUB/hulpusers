...
class _Registro1WidgetState extends State<Registro1Widget> {
  ...
  void initState() {
    ...
    _model.textFieldapTextController ??= TextEditingController();
    _model.textFieldapFocusNode ??= FocusNode();

    _model.textFieldnumdocTextController ??= TextEditingController();
    _model.textFieldnumdocFocusNode ??= FocusNode();

    _model.textFieldtelTextController ??= TextEditingController();
    _model.textFieldtelFocusNode ??= FocusNode();

    _model.textFieldcorrTextController ??= TextEditingController();
    _model.textFieldcorrFocusNode ??= FocusNode();
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Completa tus datos para empezar a solicitar servicios con confianza.',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.inter(
                                      fontWeight: FlutterFlowTheme.of(context)
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: TextFormField(
                              controller: _model.textFieldapTextController,
                              focusNode: _model.textFieldapFocusNode,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                isDense: true,
                              ...
                              cursorColor:
                                  FlutterFlowTheme.of(context).primaryText,
                              validator: _model
                                  .textFieldapTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: TextFormField(
                              controller: _model.textFieldnumdocTextController,
                              focusNode: _model.textFieldnumdocFocusNode,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                isDense: true,
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Container(
                              width: MediaQuery.sizeOf(context).width * 1.0,
                              child: TextFormField(
                                controller: _model.textFieldtelTextController,
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: MediaQuery.sizeOf(context).width * 1.0,
                        child: TextFormField(
                          controller: _model.textFieldcorrTextController,
                          focusNode: _model.textFieldcorrFocusNode,
                          autofocus: false,
                          obscureText: false,
                          decoration: InputDecoration(
                            isDense: true,
                          ...
                          validator: _model.textFieldcorrTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() =>
                                    _model.isDataUploading_imagenperfil = true);
                                ...
                                try {
                                  ...
                                  ScaffoldMessenger.of(context)
                                      .hideCurrentSnackBar();
                                  _model.isDataUploading_imagenperfil = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_imagenperfil =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_imagenperfil =
                                        downloadUrls.first;
                                  });
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              'Usaremos tu número y correo para enviarte notificaciones importantes sobre tus servicios.',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.inter(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                                ...
                                return Dialog(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: NotificacionWidget(
                                      texto: 'Selecciona el tipo de documento',
                                      verde: false,
                                    ),
                                  ),
                                );
                          ...
                          _model.emailExist = await actions.checkEmail(
                            _model.textFieldcorrTextController.text,
                          );
                          if (_model.emailExist != true) {
                            context.pushNamed(
                              ...
                              queryParameters: {
                                ...
                                'apellido': serializeParam(
                                  _model.textFieldapTextController.text,
                                  ParamType.String,
                                ),
                                'tipodocumento': serializeParam(
                                  _model.documentoValue,
                                  ParamType.String,
                                ),
                                'numerodocumento': serializeParam(
                                  _model.textFieldnumdocTextController.text,
                                  ParamType.String,
                                ),
                                'pais': serializeParam(
                                  _model.paisValue,
