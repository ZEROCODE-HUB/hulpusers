    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            Expanded(
              child: StreamBuilder<List<UsuariosRow>>(
                stream: _model.containerSupabaseStream ??= SupaFlow.client
                    ...
                    .map((list) =>
                        list.map((item) => UsuariosRow(item)).toList()),
                          ...
                          children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.network(
                                        valueOrDefault<String>(
                                          containerUsuariosRow?.fotoPerfilUrl,
                            ...
                            Padding(
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  '${valueOrDefault<String>(
                                    containerUsuariosRow?.nombres,
                                    'Esteban',
                                  )} ${valueOrDefault<String>(
                                    containerUsuariosRow?.apellidos,
                                    'López',
                                  )}',
                                  'Esteban López',
                                ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        TerminosycondicionesCopyWidget
                                            .routeName,
                                        extra: <String, dynamic>{
                                          '__transition_info__': TransitionInfo(
                                            hasTransition: true,
