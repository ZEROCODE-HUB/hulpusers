...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.appversionBackend = await AppVersionTable().queryRows(
        queryFn: (q) => q,
      );
      ...
      if (isAndroid == true) {
        ...
        if (_model.appversionBackend?.firstOrNull?.testFlight != true) {
          if (_model.versionApp2 ==
              _model.appversionBackend?.firstOrNull?.versionUsuariosIos) {
            return;
          }
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context
                                .pushNamed(RecuperarcontraseaWidget.routeName);
                          },
                          child: Text(
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (_model.userquery?.firstOrNull?.rol == 'usuario') {
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.asset(
                                        'assets/images/Captura_de_pantalla_2025-06-26_111857.png',
                                        width: 20.0,
                                        height: 20.0,
                                        fit: BoxFit.cover,
                                      ),
